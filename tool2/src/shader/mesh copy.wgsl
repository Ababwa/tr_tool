...
const TRANSFORM_OFFSET: u32 = 524288;
...
fn get_position_texture(face: vec3u, face_vertex_index: u32) -> PositionTexture {
	...
	let vertex_offset = vertices_offset + (vertex_index * vertex_size);
